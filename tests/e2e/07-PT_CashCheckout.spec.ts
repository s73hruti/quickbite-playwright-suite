...
Expected Result: Checkout completes correctly when DE is paired with cash payment — DE has only ever
...
test.describe('DE Cash Payment E2E Test', () => {
  test('DE customer completes checkout with cash payment @TC-E2E-07', async ({ page }) => {
